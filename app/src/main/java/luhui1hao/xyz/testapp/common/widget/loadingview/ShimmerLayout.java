...
public class ShimmerLayout extends FrameLayout {
    ...
    public ShimmerLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            shimmerColor = a.getColor(R.styleable.ShimmerLayout_shimmer_color, Color.GRAY);
    ...
    private void createShimmerPaint() {
        ...
        final float shimmerLineWidth = getWidth() * maskWidth;
    ...
    private int calculateMaskWidth() {
        final double shimmerLineBottomWidth = (getWidth() * maskWidth) / Math.cos(Math.toRadians(Math.abs(shimmerAngle)));
