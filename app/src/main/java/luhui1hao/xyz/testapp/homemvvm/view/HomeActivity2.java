package luhui1hao.xyz.testapp.homemvvm.view;
...
import luhui1hao.xyz.testapp.homemvvm.viewmodel.HomeViewModel;

public class HomeActivity2 extends BaseActivity implements OnRefreshListener {
    ...
    MutableLiveData<HomeData> liveData;
    ...
    private void initData() {
        ...
        liveData = (MutableLiveData<HomeData>)homeViewModel.getHomeData();
        liveData.observe(this, new Observer<HomeData>()
        {
            @Override
